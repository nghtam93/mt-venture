...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211205_metatrend_6b57885d21540f4c4073_20211205040019_archive.daf';
    const ARCHIVE_SIZE       = '61814307';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '6b57885-05040019';
    const VERSION            = '3.8.7';
